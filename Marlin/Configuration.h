...
// Seram Folger Tech Prusa i3 2020 Bed
    #define DEFAULT_bedKp 123.42
    #define DEFAULT_bedKi 8.06
    #define DEFAULT_bedKd 477.67
...
// Disables axis when it's not being used.Â
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -16.5
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 95,0} // X,Y,Z Axis Extend and Retract angles
